 ...
 * of product entries without authentication.
 *
 * @author Roman Szarowski
 */
@RestController
@RequestMapping("/store/productsUnsecure")
public class UnsecureProductController {

    private static final Logger LOGGER = LoggerFactory.getLogger(UnsecureProductController.class);

    @Resource(name = "UnsecureMongoDbProductDao")
